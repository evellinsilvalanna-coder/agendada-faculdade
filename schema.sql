...
-- Academic profile is additive: the existing authentication/users table is preserved.
ALTER TABLE users ADD COLUMN IF NOT EXISTS institution TEXT NOT NULL DEFAULT '';
...
ALTER TABLE users ADD COLUMN IF NOT EXISTS shift TEXT NOT NULL DEFAULT '';
